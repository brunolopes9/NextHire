        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            <div className="text-center mb-12">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-yellow-500 to-yellow-600 mx-auto rounded-full" />
            </div>
            ...
            <div className="space-y-8">
              {jobSeekerFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-yellow-50 transition-all duration-300 cursor-pointer"
                >
          ...
          <div>
            ...
            <div className="space-y-8">
              {employerFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-orange-50 transition-all duration-300 cursor-pointer"
                >
